...
Stage 2 is complete only as an abstract mesh simulation. The main Stage 2 demo
remains scoped to a small square matrix, real-valued orthogonal approximation,
