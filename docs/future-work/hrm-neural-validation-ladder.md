...
| 2 | complete | abstract_mesh_simulation | Deterministic abstract phase/coupler parameterization is implemented and tested without claiming a real chip mesh. |
...
| 4 | complete | synthetic_calibration_simulation | Simulation-only calibration improves or does not worsen a synthetic transfer estimate. |
