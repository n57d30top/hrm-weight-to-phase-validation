...
def run_mesh_constrained_demo(phase_levels: int = 64) -> dict:
    ...
    return {
        ...
        "complexUnitaryMeshImplemented": True,
        "complexUnitarySupportReport": "complex-unitary-mesh-support.json",
        "rectangularLayerSupportImplemented": True,
        "rectangularSupportReport": "rectangular-matrix-support.json",
        ...
        "currentDemoScope": [
            ...
            "main Stage 2 demo matrix remains square",
            "main Stage 2 demo remains a real-valued orthogonal approximation",
